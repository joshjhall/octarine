//! Crypto types shared across primitives
//!
//! Common cryptographic type definitions used by all three orthogonal concerns:
//! classification (`identifiers/crypto`), format parsing (`data/crypto`), and
//! threat assessment (`security/crypto`). Defining them centrally here keeps the
//! dependency between those sub-modules unidirectional.
