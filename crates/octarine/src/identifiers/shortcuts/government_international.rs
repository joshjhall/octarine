//! Non-US government identifier shortcuts.
//!
//! Convenience functions over [`GovernmentBuilder`](super::super::GovernmentBuilder)
//! for jurisdictions outside the US: Singapore, Australia, South Korea, Italy,
//! Turkey, Sweden, Germany, Spain, and the UK. US identifiers live in
//! [`super::government`].
