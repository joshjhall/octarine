...
octarine-core = { git = "https://github.com/joshjhall/octarine", tag = "v0.3.0-beta.6" }
```
...
```toml
[dependencies]
octarine-core = { git = "https://github.com/joshjhall/octarine", tag = "v0.3.0-beta.6", default-features = false, features = ["observe", "security"] }
```
