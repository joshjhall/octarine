...
octarine-core = { git = "https://github.com/joshjhall/octarine", tag = "v0.3.0-beta.7" }
```
...
```toml
[dependencies]
octarine-core = { git = "https://github.com/joshjhall/octarine", tag = "v0.3.0-beta.7", default-features = false, features = ["observe", "security"] }
```
